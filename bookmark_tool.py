...
class BookmarkApp(tk.Tk):
    ...
    def build_sheet_tab(self):
        ...
        self.sheet_url_label = self.register("sheet_url_label", ttk.Label(panel, style="Title.TLabel"), "sheet_url")
        self.sheet_url_label.pack(anchor="w")
        sheet_url_row = ttk.Frame(panel, style="Panel.TFrame")
        sheet_url_row.pack(fill="x", pady=(4, 10))
        ...
        self.oauth_client_label = self.register("oauth_client_label", ttk.Label(panel, style="Title.TLabel"), "oauth_client")
        self.oauth_client_label.pack(anchor="w")
        oauth_row = ttk.Frame(panel, style="Panel.TFrame")
        oauth_row.pack(fill="x", pady=(4, 12))
